  ...
  return (
    <section className="py-24 bg-slate-50 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-10 mb-16">
          ...
          <div className="hidden lg:flex shrink-0 w-12 h-12 rounded-full bg-blue-100 items-center justify-center text-blue-600 z-10">
          ...
          <div className="flex-1 bg-white rounded-[32px] p-8 md:p-12 border-2 border-blue-500 shadow-[0_20px_50px_-12px_rgba(37,99,235,0.15)] font-sans w-full relative overflow-hidden">
            ...
            <div className="flex justify-between items-end border-b-4 border-blue-500 pb-4 mb-6">
              ...
              <div className="text-blue-600 font-bold text-sm tracking-tight text-right mb-1">
            ...
            <div className="space-y-6">
              <div>
                <div className="uppercase tracking-widest text-blue-600 text-[11px] font-bold mb-2">Education</div>
                <p className="font-semibold text-slate-800 text-sm">BBA + <span className="font-bold">Post Graduate Program in Digital Marketing & Analytics</span>, BlueTick Academy</p>
              </div>

              <div>
                <div className="uppercase tracking-widest text-blue-600 text-[11px] font-bold mb-3">Live Projects</div>
                <div className="space-y-3 text-sm">
                  {[
                    "Reduced CPA from <strong class='text-blue-600'>₹1,200 → ₹380</strong> for BookMyScans, 6-week Google Ads campaign",
                    "Built lead-gen funnel generating <strong class='text-blue-600'>312 leads at ₹640 CPL</strong> for Decfort",
                    "Programmatic SEO build: <strong class='text-blue-600'>400+ pages, 18K organic visits/month</strong>",
                    "Email lifecycle automation in Klaviyo: <strong class='text-blue-600'>42% open rate, 8% CTR</strong>",
                    "AI ad creative pipeline (GPT-4 + Midjourney): <strong class='text-blue-600'>200+ variants shipped/week</strong>",
                    "Marketing automation with n8n: <strong class='text-blue-600'>12 workflows live</strong> for EY",
                    "Live Looker Studio dashboard for Razorpay across <strong class='text-blue-600'>5 channels</strong>",
                    "WhatsApp campaign on Gupshup: <strong class='text-blue-600'>28% reply rate, ₹47 CPL</strong>"
                  ].map((html, idx) => (
              ...
              <div>
                <div className="uppercase tracking-widest text-blue-600 text-[11px] font-bold mb-2">Tools</div>
                <div className="flex flex-wrap gap-2">
                  {['Google Ads', 'Meta Ads', 'GA4', 'Looker Studio', 'GPT-4', 'Midjourney', 'Ahrefs', 'n8n', 'Klaviyo', '+11 more'].map(tool => (
              ...
              <div>
                <div className="uppercase tracking-widest text-blue-600 text-[11px] font-bold mb-2">Certifications</div>
                <div className="flex flex-wrap gap-2">
                  {['Google Ads (5)', 'Microsoft Ads', 'Meta Blueprint', 'HubSpot Inbound', 'HubSpot Content', 'SEMrush SEO'].map(cert => (
              ...
              <div>
                <div className="uppercase tracking-widest text-blue-600 text-[11px] font-bold mb-2">AI Stack</div>
                <div className="flex flex-wrap gap-2">
                  {['Custom GPTs', 'Prompt engineering for performance', 'AI-driven attribution modeling'].map(ai => (
