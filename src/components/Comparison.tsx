    ...
    <section className="py-24 bg-white px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="text-4xl md:text-[56px] font-extrabold text-slate-900 tracking-tight leading-[1.1] mb-16 max-w-4xl">
          How our <span className="text-blue-600">digital marketing institute in Bangalore</span> compares to your other options
        </h2>
        ...
        <div className="overflow-x-auto pb-8">
          <div className="min-w-[900px]">
            ...
            <div className="flex rounded-t-2xl overflow-hidden">
              ...
              {/* BlueTick Column */}
              <div className="w-[26%] bg-gradient-to-r from-[#211155] to-[#140B30] p-6 text-white font-bold flex items-center justify-between border-b-4 border-orange-500">
                <span className="tracking-widest text-sm uppercase">BLUETICK</span>
