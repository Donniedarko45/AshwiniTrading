...
export default function WhyHireUs() {
  ...
  return (
    <section className="bg-white py-32 px-6 lg:px-8 border-t border-slate-100">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#111827] tracking-tight leading-[1.1] mb-6">
            Why <span className="text-blue-600">500+</span> Bangalore companies pick our graduates <span className="underline decoration-blue-200 underline-offset-4">first.</span>
          </h2>
