...
export default function ResumeCTA() {
  return (
    <section className="py-24 relative overflow-hidden bg-brand-bg-dark">
      {/* Background gradients */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-brand-accent via-brand-bg-dark to-brand-bg-deep" />
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center text-white">
        ...
        <h2 className="text-4xl md:text-6xl font-extrabold mb-6 leading-[1.1] tracking-tight">
          In 120 days, your resume looks <span className="text-brand-secondary">completely different.</span>
        </h2>
