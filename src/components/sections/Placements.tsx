...
export default function Placements() {
  const placementBands = [
    { label: "₹3-5 LPA", percent: 26, desc: "Freshers joining agencies as executives", color: "bg-brand-blue", glow: "shadow-[0_0_15px_rgba(59,130,246,0.3)]" },
    { label: "₹5-8 LPA", percent: 54, desc: "Mid-tier agencies & funded startups", color: "bg-brand-indigo", glow: "shadow-[0_0_15px_rgba(99,102,241,0.3)]" },
    { label: "₹8-12 LPA", percent: 16, desc: "Jr Working pros switching careers, top performers", color: "bg-brand-orange", glow: "shadow-[0_0_15px_rgba(249,115,22,0.3)]" },
    { label: "₹12+ LPA", percent: 4, desc: "", color: "bg-rose-500", glow: "shadow-[0_0_15px_rgba(244,63,94,0.3)]" },
  ];

  return (
    <section className="bg-brand-bg-dark py-32 px-6 lg:px-8 relative overflow-hidden">
       {/* Glow Effect */}
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-brand-indigo/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto z-10 relative">
        ...
        >
          <div className="text-brand-blue font-bold tracking-widest text-sm uppercase mb-4">Digital Marketing Course in Bangalore</div>
          <h3 className="text-white text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tighter leading-[1.1] mb-6">
            with <span className="text-brand-purple">100% placement</span> — here's the package band.
          </h3>
              ...
              <div className="space-y-10">
                ...
                <div className="flex justify-between items-start pt-2">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-brand-emerald text-xs font-bold uppercase tracking-wider">Flipkart, 2026</div>
                  </div>
                </div>
              </div>
            </div>
