        ...
        <div className="relative mb-20">
          ...
          <div className="md:absolute bottom-[-40px] left-1/2 md:-translate-x-1/2 w-full md:w-[80%] max-w-3xl bg-white rounded-2xl p-5 sm:p-8 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] border border-slate-100 mt-[-60px] md:mt-0 relative z-10">
            <div className="flex flex-col md:flex-row md:items-center gap-4 mb-4">
              ...
              <div className="bg-blue-50 text-brand-blue px-3 py-1 rounded-full text-sm font-bold flex items-center gap-2 md:ml-auto w-max">
                Tuesday <span className="w-1 h-1 rounded-full bg-blue-300" /> 10:30 AM
              </div>
            </div>
            
            {/* Mobile shows these in block instead */}
            <div className="text-brand-blue font-bold text-lg mb-4 md:hidden">
