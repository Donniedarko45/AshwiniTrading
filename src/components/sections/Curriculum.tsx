...
export default function Curriculum() {
  ...
  return (
    <section id="curriculum" className="bg-white py-16 md:py-24 px-5 sm:px-6 md:px-12">
       <div className="max-w-7xl mx-auto text-center mb-12 sm:mb-16">
          ...
          <p className="text-slate-600 text-base sm:text-lg font-medium max-w-3xl mx-auto leading-relaxed mb-8 sm:mb-10">
             ...
             {curriculumData.map(course => {
                ...
                return (
                  <button 
                    ...
                    className={`px-5 py-3.5 rounded-full font-bold text-sm tracking-wide transition-all border touch-target flex items-center justify-center ${
             ...
             <div className="flex items-center justify-between border-b border-slate-200 pb-4 mb-8">
                <div>
                 ...
                 <div className="flex flex-col items-end gap-1.5">
                    ...
                    <span className="bg-brand-orange text-white text-[10px] font-bold px-3 py-1 rounded-full flex items-center gap-1 animate-pulse">
                      SWIPE →
                    </span>
                 </div>
             </div>
             ...
             <div className="flex overflow-x-auto gap-6 pb-8 snap-x">
                {activeCourse.modules.map((mod, index) => {
                  ...
                  return (
                     <div 
                       key={index}
                       className={`min-w-[280px] sm:min-w-[340px] md:min-w-[400px] rounded-3xl p-6 shadow-sm snap-start shrink-0 border ${
                         isNoteCard 
