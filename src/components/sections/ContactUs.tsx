    ...
    <section className="bg-brand-bg-deep pt-32 pb-24 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="max-w-[1300px] mx-auto relative z-10 space-y-16">
        ...
        <div className="rounded-3xl overflow-hidden border border-slate-200 shadow-md h-96 w-full relative group">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.8288769324683!2d77.6376375!3d12.9780407!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae17a630a06935%3A0x72fbac409f91095b!2sAshwini%20Trading%20Academy!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin" 
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
