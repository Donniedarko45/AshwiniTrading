...
export default function Navbar() {
  ...
  return (
    <>
      <motion.nav 
        className={`fixed top-0 left-0 right-0 z-50 transition-colors duration-0 ${
          isScrolled || isOpen
        ...
        <div className="flex items-center justify-between px-6 lg:px-12 max-w-[1600px] mx-auto">
          ...
          >
            <motion.a 
              ...
              whileTap={{ scale: 0.98 }}
              className="px-6 py-2.5 bg-brand-primary text-brand-navy text-sm font-bold tracking-widest hover:bg-brand-primary-light transition-colors border border-transparent cursor-pointer inline-flex items-center justify-center uppercase"
            >
              Join Us
            </motion.a>
            ...
            <motion.button 
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className={`hidden 2xl:block px-6 py-2.5 border text-sm font-bold tracking-widest uppercase transition-colors ${
                isScrolled || isOpen 
                  ? 'border-slate-300 text-brand-navy hover:bg-slate-50 bg-white' 
            ...
            <a
              ...
              className={`flex items-center gap-2 px-5 py-2.5 border text-sm font-bold tracking-widest uppercase transition-colors ${
                isScrolled || isOpen
                  ? 'border-slate-300 text-brand-navy hover:bg-slate-50 bg-white'
                  : 'border-white/30 text-white hover:bg-white/10 bg-transparent'
              }`}
            >
              <div className="bg-brand-primary p-1 w-5 h-5 flex items-center justify-center">
            ...
            <a
              ...
              className={`hidden 2xl:flex items-center gap-2 px-5 py-2.5 border text-sm font-bold tracking-widest uppercase transition-colors ${
                isScrolled || isOpen
                  ? 'border-slate-300 text-brand-navy hover:bg-slate-50 bg-white'
                  : 'border-white/30 text-white hover:bg-white/10 bg-transparent'
              }`}
            >
              <div className="bg-brand-secondary p-1 w-5 h-5 flex items-center justify-center">
          ...
          <div className="flex xl:hidden items-center gap-2.5">
            <a
              href="tel:+919845961990"
              className={`p-3 border hover:bg-slate-100/50 active:bg-slate-100 transition-colors flex items-center justify-center ${
                isScrolled || isOpen
                  ? 'border-slate-300 text-brand-navy'
          ...
          >
            ...
            <div className="flex flex-col gap-4 mt-8 pb-safe">
              <a
                href="tel:+919845961990"
                onClick={closeMenu}
                className="flex items-center justify-center gap-3 w-full py-4 border border-slate-300 bg-brand-primary text-brand-navy text-base font-bold tracking-widest uppercase hover:bg-brand-primary-light transition-colors"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={closeMenu}
                className="flex items-center justify-center gap-3 w-full py-4 border border-brand-secondary bg-brand-secondary text-white text-base font-bold tracking-widest uppercase hover:bg-brand-secondary-hover transition-colors"
              >
              ...
              <a
                href="#/join-us"
                onClick={closeMenu}
                className="flex items-center justify-center w-full py-4 border border-brand-primary bg-brand-primary text-brand-navy text-base font-bold tracking-widest uppercase hover:bg-brand-primary-light transition-colors text-center"
              >
                Join Us
              </a>
              ...
              <button
                ...
                className="w-full py-4 border border-slate-300 text-brand-navy text-base font-bold tracking-widest uppercase hover:bg-slate-50 transition-colors bg-white"
              >
                Hire from us
              </button>
            </div>
