      ...
      >
        <div className="flex items-center justify-between px-6 lg:px-12 max-w-[1600px] mx-auto">
          ...
          >
            ...
            >
              <div className="bg-brand-orange rounded-full p-1 w-5 h-5 flex items-center justify-center shadow-[0_0_10px_rgba(234,88,12,0.5)]">
          ...
          >
            ...
            <div className="flex flex-col gap-4 mt-8 pb-safe">
              <a
                href="tel:+919845961990"
                onClick={closeMenu}
                className="flex items-center justify-center gap-3 w-full py-4 rounded-xl bg-brand-orange text-white text-base font-bold tracking-wide hover:bg-brand-orange/90 transition-colors shadow-lg shadow-orange-500/20"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={closeMenu}
                className="flex items-center justify-center gap-3 w-full py-4 rounded-xl bg-[#25D366] text-white text-base font-bold tracking-wide hover:bg-[#22c35e] transition-colors shadow-lg shadow-emerald-500/20"
              >
