    ...
    <section className="bg-[#F2F7FF] py-24 relative" style={{
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl mb-16">
            ...
            <p className="text-slate-600 text-lg font-medium">Every name below is a verified Ashwini Trading Academy alumnus.</p>
          </div>
             ...
             {alumniList.map((alum, i) => (
                <div key={i} className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 hover:shadow-lg transition-all flex flex-col items-start">
                   ...
                   <div className="flex items-center gap-2 mb-1">
                      ...
                      <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 text-blue-600 hover:text-blue-700 text-xs font-bold transition-colors" title="Verify Placement on LinkedIn">
