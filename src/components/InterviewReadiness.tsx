    ...
    <section className="py-24 bg-white px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-4xl md:text-[56px] font-extrabold text-slate-900 tracking-tight leading-[1.1] mb-16 max-w-4xl">
          How most freshers walk into a digital marketing interview – <span className="text-blue-600">and how BlueTick students walk in</span>
        </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {/* Others Card */}
          <div className="bg-white border-t-[6px] border-red-400 rounded-2xl p-8 md:p-12 shadow-sm border border-slate-100">
          ...
          {/* BlueTick Card */}
          <div className="bg-white border-t-[6px] border-blue-600 rounded-2xl p-8 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-[6px] bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-500"></div>
            <h3 className="text-2xl font-bold text-slate-900 mb-8">How BlueTick students attend interviews</h3>
            <ul className="space-y-6">
              {blueTickList.map((item, idx) => (
                <li key={idx} className="flex gap-4">
